...
ax1.loglog(step_sizes, data_AB4, "o-", color="peru", label="AB4")
ax1.loglog(step_sizes, data_AB5, "o-", color="sandybrown", label="AB5")
ax1.loglog(step_sizes, data_RK4, "o-", color="goldenrod", label="RK4")
ax1.set_ylabel("Absolute Error")
ax1.legend(loc=6)
ax2 = ax1.twinx()
ax2.loglog(step_sizes, timings_AB4, "o-", color="cornflowerblue", label="AB4")
ax2.loglog(step_sizes, timings_AB5, "o-", color="mediumpurple", label="AB5")
ax2.loglog(step_sizes, timings_RK4, "o-", color="midnightblue", label="RK4")
ax2.set_ylabel("Execution time [ns]")
ax2.legend(loc=7)
plt.savefig("./plots/performance_RK_vs_LMM.pdf",
